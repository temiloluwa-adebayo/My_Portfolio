...
export const Hero = () => {
  ...
  return (
    <section id="top" ref={ref} className="relative isolate flex min-h-[100svh] items-center overflow-hidden pt-28 pb-24 md:pt-32">
      {/* Background slideshow: decorative, generated atmosphere */}
      <motion.div aria-hidden="true" className="absolute inset-0 -z-20" style={reduce ? undefined : { y: bgY }}>
      ...
      <div aria-hidden="true" className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,var(--color-page)_8%,rgba(18,18,18,0.82)_45%,rgba(18,18,18,0.35)_100%)]" />
      <div aria-hidden="true" className="absolute inset-x-0 bottom-0 -z-10 h-48 bg-gradient-to-t from-page to-transparent" />
      <div aria-hidden="true" className="absolute inset-x-0 top-0 -z-10 h-32 bg-gradient-to-b from-page/80 to-transparent" />
      ...
      <Container>
        <motion.div style={reduce ? undefined : { y: contentY, opacity: contentOpacity }} className="grid items-center gap-12 lg:grid-cols-[1.35fr_1fr] lg:gap-16">
          <div className="min-w-0">
            <motion.div {...rise(0.15)} className="mb-7 inline-flex items-center gap-2.5 rounded-full border border-line-strong bg-page/60 py-1.5 pr-4 pl-3 text-sm text-fg backdrop-blur-md">
            ...
            <motion.p {...rise(0.25)} className="mb-4 text-[0.95rem] text-muted">
            ...
            <motion.h1
              ...
              className="font-display text-[3.2rem] leading-[0.95] font-semibold tracking-[-0.03em] sm:text-7xl lg:text-[5.75rem]"
            >
            ...
            <motion.p {...rise(0.9)} className="mt-7 max-w-[36rem] text-[1.08rem] leading-relaxed text-muted md:text-lg">
              {PROFILE.intro}
            </motion.p>
            ...
            <motion.ul {...rise(1.2)} className="mt-10 flex flex-wrap gap-x-6 gap-y-2 text-sm text-muted" aria-label="Highlights">
              {PROOF.map((p) => (
